...
function FacePage() {
    ...
    const [scanComplete, setScanComplete] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const detectionStableFrames = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(0);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FacePage.useEffect": ()=>{
            ...
            return ({
                "FacePage.useEffect": ()=>window.removeEventListener("resize", resize)
            })["FacePage.useEffect"];
        }
    }["FacePage.useEffect"], []);
    // -----------------------------
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FacePage.useEffect": ()=>{
            const t1 = setTimeout({
                "FacePage.useEffect.t1": ()=>setLoading(false)
            }["FacePage.useEffect.t1"], 5000);
            return ({
                "FacePage.useEffect": ()=>clearTimeout(t1)
            })["FacePage.useEffect"];
        }
    }["FacePage.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FacePage.useEffect": ()=>{
            ...
            const t = setTimeout({
                "FacePage.useEffect.t": ()=>{
                    setAuthorized(true);
                    setFadeOut(true);
                    // setTimeout(() => router.push("/dashboard"), 900);
                    window.location.href = "./video";
                }
            }["FacePage.useEffect.t"], 500);
            return ({
                "FacePage.useEffect": ()=>clearTimeout(t)
            })["FacePage.useEffect"];
        }
    }["FacePage.useEffect"], [
        scanComplete,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FacePage.useEffect": ()=>{
            ...
            faceMesh.onResults({
                "FacePage.useEffect": (results)=>{
                    ...
                    if (results.multiFaceLandmarks && results.multiFaceLandmarks.length > 0) {
                        ...
                        ctx.lineWidth = 1.5;
                        landmarksGlobal.forEach({
                            "FacePage.useEffect": (lm)=>{
                        ...
                        ctx.strokeStyle = "rgba(0,255,255,".concat(0.3 + 0.7 * Math.abs(Math.sin(sweepProgress * Math.PI * 2)), ")");
                        ctx.lineWidth = 3;
                        ctx.beginPath();
                        landmarksGlobal.forEach({
                            "FacePage.useEffect": (lm, i)=>{
                                const x = canvas.width - lm.x * canvas.width;
                                const y = lm.y * canvas.height;
                        ...
                        particles.current.forEach({
                            "FacePage.useEffect": (p)=>{
                                ...
                                ctx.fillStyle = "rgba(0,255,255,".concat(p.alpha, ")");
                                ctx.beginPath();
            ...
            const camera = new window.Camera(video, {
                onFrame: {
                    "FacePage.useEffect": async ()=>await faceMesh.send({
                            image: video
                        })
                }["FacePage.useEffect"],
                width: 1280,
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    scanComplete && !authorized && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    authorized && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$styled$2d$jsx$2f$style$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                id: "686acf85f585cf1f",
                children: ".gridOverlay.jsx-686acf85f585cf1f{pointer-events:none;z-index:15;background-image:linear-gradient(90deg,rgba(0,255,255,.1) 1px,transparent 1px),linear-gradient(rgba(0,255,255,.1) 1px,transparent 1px);background-size:60px 60px;animation:6s linear infinite gridShift;position:absolute;top:0;bottom:0;left:0;right:0}@keyframes gridShift{0%{background-position:0 0}to{background-position:60px 60px}}.loadingWrap.jsx-686acf85f585cf1f{-webkit-backdrop-filter:blur(8px);backdrop-filter:blur(8px);z-index:30;justify-content:center;align-items:center;display:flex;position:absolute;top:0;bottom:0;left:0;right:0}.orbLoader.jsx-686acf85f585cf1f{justify-content:center;align-items:center;width:120px;height:120px;display:flex}.orb.jsx-686acf85f585cf1f{background:radial-gradient(circle,#cfffff,#75f5ff);border-radius:50%;width:55px;height:55px;animation:1.6s ease-in-out infinite pulseOrb;box-shadow:0 0 35px rgba(0,255,255,.9)}@keyframes pulseOrb{0%{opacity:.55;transform:scale(1)}50%{opacity:1;transform:scale(1.35)}to{opacity:.55;transform:scale(1)}}.scanComplete.jsx-686acf85f585cf1f{color:#afffff;opacity:0;z-index:40;font-size:32px;animation:.7s ease-out forwards scanPop;position:absolute;top:12%;left:50%;transform:translate(-50%)translateY(-20px)}@keyframes scanPop{0%{opacity:0;transform:translate(-50%)translateY(-30px)scale(.8)}to{opacity:1;transform:translate(-50%)translateY(0)scale(1)}}.authorizedPopup.jsx-686acf85f585cf1f{-webkit-backdrop-filter:blur(12px);backdrop-filter:blur(12px);color:#afffff;text-shadow:0 0 12px #afffff;z-index:50;background:rgba(255,255,255,.1);border:1px solid rgba(200,255,255,.5);border-radius:14px;padding:22px 55px;font-size:34px;animation:.1s ease-out forwards authPop,1.8s ease-in-out infinite authGlow;position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)scale(.75);box-shadow:0 0 30px rgba(0,255,255,.6)}@keyframes authPop{0%{opacity:0;transform:translate(-50%,-50%)scale(.4)}to{opacity:1;transform:translate(-50%,-50%)scale(1)}}@keyframes authGlow{0%{box-shadow:0 0 20px rgba(0,255,255,.4)}50%{box-shadow:0 0 45px rgba(0,255,255,.9)}to{box-shadow:0 0 20px rgba(0,255,255,.4)}}"
            }, void 0, false, void 0, this)
        ]
    }, void 0, true);
}
_s(FacePage, "Riik17JFPo1P6fVojixwBA6gnRY=", false, function() {
    return [
...
//# sourceMappingURL=_4bd1e658._.js.map